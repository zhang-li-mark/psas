...
tabiframeId = function() {
	return top.$(".POWERMS_iframe:visible").attr("id")||top.$(".layui-layer-content").attr("id");//弹窗id
}
...
$.currentIframe = function () {
	...
	if(iframeId.indexOf("_win_")!=-1){
		iframeId="__"+iframeId;
	}
	return top.frames[iframeId].contentWindow != undefined
			? top.frames[iframeId].contentWindow
			: top.frames[iframeId];
}
