(function(n, t) {
	...
	function u() {
		n.each(i.excelImportTemplate, function(n, t) {
	...
	t.data = {
		...
		get : function(n) {
			...
			if (!n)
				return "";
			var e = n.length, t = "", f = i;
			for (u = 0; u < e; u++)
				if (t = r(n[u], f), t != "" && t != undefined)
					f = t;
				else
					break;
			...
			if ($(this).data("id") == t)
				return $(this).hasClass("active")
						|| ($(this).addClass("active").siblings(".menuTab")
								...
								.scrollToTab(this), $(".mainContent .LRADMS_iframe")
								.each(function() {
									if ($(this).data("id") == t)
										return $(this).show()
												.siblings(".LRADMS_iframe")
												.hide(), !1
								})), r = !1, !1
		});
		r && (u = '<a href="javascript:;" class="active menuTab" data-id="'
						+ t + '">' + e + ' <i class="fa fa-remove"><\/i><\/a>', $(".menuTab")
						.removeClass("active"), f = '<iframe class="LRADMS_iframe" id="iframe'
						+ i
						+ '" name="iframe'
						+ i
						...
						.find("iframe.LRADMS_iframe").hide(), $(".mainContent")
						.append(f), learun.loading({
							isShow : !0
...
(function(n) {
	n.learuntab = {
		...
		refreshTab : function() {
			var i = n(".page-tabs-content").find(".active").attr("data-id"), t = n('.LRADMS_iframe[data-id="'
					+ i + '"]'), r = t.attr("src");
			learun.loading({
						isShow : !0
					});
		...
		activeTab : function() {
			...
			n(this).hasClass("active")
					|| (n(".mainContent .LRADMS_iframe").each(function() {
						if (n(this).data("id") == t)
							return n(this).show().siblings(".LRADMS_iframe")
									.hide(), !1
		...
		closeOtherTabs : function() {
			n(".page-tabs-content").children("[data-id]").find(".fa-remove")
					.parents("a").not(".active").each(function() {
						n('.LRADMS_iframe[data-id="' + n(this).data("id")
								+ '"]').remove();
						n(this).remove()
					});
			...
			return n(this).parents(".menuTab").hasClass("active")
					? (n(this).parents(".menuTab").next(".menuTab").size()
							&& (t = n(this).parents(".menuTab")
									...
									.addClass("active"), n(".mainContent .LRADMS_iframe")
									.each(function() {
										if (n(this).data("id") == t)
											return n(this).show()
													.siblings(".LRADMS_iframe")
									...
									.parents(".menuTab").remove(), n(".mainContent .LRADMS_iframe")
									.each(function() {
												if (n(this).data("id") == i)
									...
									.each(function() {
										if (n(this).data("id") == t)
											return n(this).show()
													.siblings(".LRADMS_iframe")
													.hide(), !1
									}), n(this).parents(".menuTab").remove(), n(".mainContent .LRADMS_iframe")
									.each(function() {
												if (n(this).data("id") == i)
													return n(this).remove(), !1
											})))
		...
		addTab : function() {
			...
			var t = n(this).attr("href"), e = n.trim(n(this).text()), r = !0;
						...
						if (n(this).data("id") == t)
							return n(this).hasClass("active")
									|| (n(this).addClass("active")
											.siblings(".menuTab")
											.removeClass("active"), n.learuntab
											.scrollToTab(this), n(".mainContent .LRADMS_iframe")
											.each(function() {
												if (n(this).data("id") == t)
													return n(this)
															.show()
							...
							&& (u = '<a href="javascript:;" class="active menuTab" data-id="'
									...
									.find("iframe.LRADMS_iframe").hide(), n(".mainContent")
									.append(f), learun.loading({
										isShow : !0
									}), n(".mainContent iframe:visible").load(
									function() {
										learun.loading({
													isShow : !1
												})
		...
		init : function() {
			...
			n(".tabCloseCurrent").on("click", function() {
						n(".page-tabs-content").find(".active i")
								.trigger("click")
					});
			...
			n(".fullscreen").on("click", function() {
				return n(this).attr("fullscreen")
						? (n(this).removeAttr("fullscreen"), n.learuntab
								.exitFullscreen(), !1)
						: (n(this).attr("fullscreen", "true"), n.learuntab
								.requestFullScreen(), !1)
			})
		}
	};
	n.learunindex = {
		load : function() {
			n("#content-wrapper").find(".mainContent").height(n(window)
					.height()
					- 158);
			...
			i.find("li").click(function() {
				...
				n.each(f, function(i) {
					var u = f[i], e = n.learunindex.jsonWhere(t, function(n) {
								return n.F_ParentId == u.F_ModuleId
							});
					e.length > 0
							...
							: r += '<li><a class="menuItem" data-id="'
									+ u.F_ModuleId + '" href="'
									+ u.F_UrlAddress + '"><i class="fa '
									+ u.F_Icon + '"><\/i><span>' + u.F_FullName
									+ "<\/span><\/a><\/li>"
				});
		...
		loadDesktop : function() {
			...
			if (n(".slidebox").length > 0) {
				var u = [{
							...
							F_ModifyUserId : "System",
							F_ModifyUserName : "超级管理员"
						}], o = ["2e99d4", "fe8977 ", "9dd6d7  ", "b5adab",
						"8ebdd4", "edd46e", "64cfa7", "FFA300", "708FE3",
						"D972E3", "56BD4E", "1ABC9C", "2e99d4"], t = "";
				for (n.each(u, function(n) {
					var i = u[n], r;
					i.F_Target == "iframe"
							&& (r = Math.round(Math.random() * 9 + 1), t += '<li class="menuItem" data-id="'
									+ i.F_ModuleId
									+ '" href="'
									+ i.F_UrlAddress + '">', t += '    <div class="icon" style="background: #'
									+ o[r] + ';">', t += '        <i class="fa '
									+ i.F_Icon + '"><\/i>', t += "     <\/div>", t += '     <div class="icon-text">', t += "         <span>"
									+ i.F_FullName + "<\/a>", t += "     <\/div>", t += "<\/li>")
				}), n(".slidebox ul").append(t), i = n(".slidebox > ul"), f = i
						.children("li"), f.each(function(n, t) {
							n % 28 == 0 && i.before("<ul>");
							i.prev("ul").append(t)
						}), i.remove(), e = Math
						.ceil(n(".slidebox>ul>li").length / 28), r = 0; r < e; r++)
					n(".slidebox-slider ul")
							.prepend('<li><i class="fa fa-circle"><\/i><\/li>');
				...
				n(".slidebox").width(n(".slidebox").width()
						* n(".slidebox>ul").length)
			}
		},
		indexOut : function() {
